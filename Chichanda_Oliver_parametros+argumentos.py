def Pollo_gus(*datos):
  ...
  factura = 0
  detalle = ""
  print(f"***** Bienvenido a Asadero GUstambo, ganas de un gusto?, {nombre} ? te lo mereces *****\n")
  ...
  if opcion_menu == "1":
    ...
    print("**** Menu Hamburguesas GUStambo ****")
    print("1. ***** Hamburguesa clasica con papas ***** ($5)")
    hamburguesa = input("Ingresa tu orden: ")
    if hamburguesa == "1":
      factura = 5
      detalle = "Hamburguesa clasica con papas"
      
  if factura > 0:
    print("\n---------------------------------")
    print("Gracias por tu compra,", nombre, "<3")
...
Pollo_gus(nombre_cliente, input("Escoge una opción (1, 2 o 3): "))